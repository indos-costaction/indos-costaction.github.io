...
{% assign leaders = site.data.members | where_exp: "member", "member.coordination contains 'WG2 leader'" %}
{% assign co_leaders = site.data.members | where_exp: "member", "member.coordination contains 'WG2 co-leader'" %}
