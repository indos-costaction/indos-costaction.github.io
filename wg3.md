...
The **Federated Journal Club** is a trainee-oriented reading activity, transversal
across WG3's Task Forces, in which participants collaboratively read and critically
annotate the neuroimaging-preprocessing literature across nine imaging modalities plus
a cross-modality methods category. It is **open to everyone** — no INDoS membership
required — and especially welcomes trainees and early-career researchers.

Everything you need to take part — eligibility, how to claim and review papers, a
guide on how to read a paper, and the live leaderboard — lives on the dedicated
**[Federated Journal Club site](https://www.indos-costaction.eu/journal-club/)**.

👉 **[Join the Journal Club →](https://www.indos-costaction.eu/journal-club/participate.html)**
