...
<div class="wide-card">
  ...
  <table style="width: 80%; text-align: left; vertical-align: top;">
    ...
    <td><h4>Co-leader:</h4>{% include person id="michal" %}</td>
  </table>
</div>
...
<div class="wide-card">
  ...
  <table style="width: 80%; text-align: left; vertical-align: top;">
    ...
    <td><h4>Co-leader:</h4>{% include person id="andjela" %}</td>
  </table>
</div>
...
<div class="wide-card">
  ...
  <table style="width: 80%; text-align: left; vertical-align: top;">
    ...
    <td><h4>Co-leader:</h4>{% include person id="guiomar" %}</td>
  </table>
</div>
...
<div class="wide-card">
  ...
  <table style="width: 80%; text-align: left; vertical-align: top;">
    ...
    <td><h4>Co-leader:</h4>{% include person id="jochem" %}</td>
  </table>
</div>
...
<div class="wide-card">
  ...
  <table style="width: 80%; text-align: left; vertical-align: top;">
    <td><h4>Leader:</h4>{% include person id="mathew" %}</td>
